...
const MOCK_DATA = {
  chats: {
    1: {
      id: 1, type: 'direct',
      name: '@alex_ventures',
      avatarBg: 'linear-gradient(145deg,#c44daf 0%,#9b6dff 100%)',
      avatarLabel: 'А',
      online: true,
      unread: 3,
    ...
    2: {
      id: 2, type: 'direct',
      name: '@maria_builds',
      avatarBg: 'linear-gradient(145deg,#a78bfa 0%,#7c3aed 100%)',
      avatarLabel: 'М',
      online: false,
      unread: 0,
    ...
    3: {
      id: 3, type: 'direct',
      name: '@nova_dev',
      avatarBg: 'linear-gradient(145deg,#f06aba 0%,#9b6dff 100%)',
      avatarLabel: 'N',
      online: true,
      unread: 1,
    ...
    4: {
      ...
      avatarBg: 'linear-gradient(145deg,#9b6dff 0%,#6d28d9 100%)',
    ...
    5: {
      id: 5, type: 'group',
      name: 'Дизайн 2.0',
      avatarBg: 'linear-gradient(145deg,#f06aba 0%,#be185d 100%)',
      avatarLabel: null,
      online: null,
      unread: 0,
